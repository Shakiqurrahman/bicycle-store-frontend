...
const EditBycle = () => {
  ...
  const product: TProductData = location.state;
  ...
  const [formData, setFormData] = useState({
    ...
    image: product.imageUrl || (null as File | null),
    imagePreview: product.imageUrl || (null as string | null),
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate("/dashboard/bicycle-management");
    } catch (error) {
